"""add token version, lockout columns, and refresh_tokens

Revision ID: 0003_auth_sessions_lockout
...
revision: str = "0003_auth_sessions_lockout"
down_revision: Union[str, Sequence[str], None] = "0002_add_email_verification"
